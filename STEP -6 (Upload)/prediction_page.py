...
def display_prediction():
    with open(r"C:\Users\puruc\OneDrive\Documents\CampusX\Projects\House Price Prediction\STEP -6 (Upload)\df.pkl",'rb') as file :
        df = pickle.load(file)

    with open(r"C:\Users\puruc\OneDrive\Documents\CampusX\Projects\House Price Prediction\STEP -6 (Upload)\best_pipeline.pkl",'rb') as file :
