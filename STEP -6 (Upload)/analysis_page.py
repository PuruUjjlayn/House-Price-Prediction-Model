...
def display_analysis():
    ...
    st.title('Analytics')
    new_df = pd.read_csv(r"C:\Users\puruc\OneDrive\Documents\CampusX\Projects\House Price Prediction\STEP -6 (Upload)\data_viz1.csv")
    ...
    # feature pkl file
    feature_data = pickle.load(open(r"C:\Users\puruc\OneDrive\Documents\CampusX\Projects\House Price Prediction\STEP -6 (Upload)\sector_feature_dict.pkl",'rb'))
    ...
    # 6. Side by Side Hist_Kde_plot for property type
